...
RavenRAG uses a **dual-license model**: open source for the community,
...
RavenRAG is licensed under the
...
- File loaders and watch mode
- CLI tool (`raven`)
- Pluggable embedding backends (Ollama, custom)
...
1. Distribute RavenRAG inside a product **without** releasing your source under AGPLv3
2. Offer RavenRAG as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to take RavenRAG,
...
Open an issue: https://github.com/egkristi/ravenrag/issues
